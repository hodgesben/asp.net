<%@ Page Language="C#" AutoEventWireup="true" CodeFile="instructor.aspx.cs" Inherits="db" EnableSessionState=true%>
...
<body>
  <form id="adminPage" runat="server"> 
    ...
    <asp:Button id="classHome" onclick="goHome" runat="server" Text="Instructor Home"></asp:Button>
    ...
    <asp:Panel ID="addPanel" runat="server" Wrap="true" Visible="false">
      ...
      <h3>First Name</h3><asp:TextBox ID="add_instructorfNameTB" MaxLength="20" runat="server"/> 
      <h3>Last Name</h3><asp:TextBox ID="add_instructorlNameTB" MaxLength="20" runat="server"   /> 
      <h3>Email</h3><asp:TextBox ID="add_instructorEmailTB" MaxLength="20" runat="server"   /> 
      <h3>Phone</h3><asp:TextBox ID="add_instructorPhoneTB" MaxLength="20" runat="server"   /> 
      <h3>Password</h3><asp:TextBox ID="add_instructorPasswordTB" MaxLength="20" runat="server"   /> 
   ...
   <asp:Panel ID="addConformation" runat="server" Wrap="true" Visible="false">
    ...
    <asp:Panel ID="updateTable" runat="server" Wrap="true" Visible="false">
      ...
      <asp:ListBox id="update_instructorNamesLB" AutoPostBack="true" OnSelectedIndexChanged="update_record" runat="server"/></asp:ListBox>
    </asp:Panel>
    ...
    <asp:Panel ID="updatePannel" runat="server" Wrap="true" Visible="false">
      ...
      <h3>First Name</h3><asp:TextBox id="update_instructorfNameTB" runat="server"/>
      <h3>Last Name</h3><asp:TextBox id="update_instructorlNameTB" runat="server"/>
      <h3>Email</h3><asp:TextBox id="update_instructorEmailTB" runat="server"/>
      <h3>Phone</h3><asp:TextBox id="update_instructorPhoneTB" runat="server"/>
      <h3>Password</h3><asp:TextBox id="update_instructorPasswordTB" runat="server"/>
    ...
    <asp:Panel ID="deleteTable" runat="server" Wrap="true" Visible="false">
      ...
      <asp:ListBox id="delete_instructorNamesLB" AutoPostBack="true" OnSelectedIndexChanged="delete_record" runat="server"/></asp:ListBox>
    </asp:Panel> 
    <asp:Panel ID="deletePannel" runat="server" Wrap="true" Visible="false">
      ...
      <h3>First Name</h3><asp:TextBox id="delete_instructorfNameTB" runat="server"/>
      <h3>Last Name</h3><asp:TextBox id="delete_instructorlNameTB" runat="server"/>
      <h3>Email</h3><asp:TextBox id="delete_instructorEmailTB" runat="server"/>
      <h3>Phone</h3><asp:TextBox id="delete_instructorPhoneTB" runat="server"/>
      <h3>Password</h3><asp:TextBox id="delete_instructorPasswordTB" runat="server"/>
