<%@ Page Language="C#" AutoEventWireup="true" CodeFile="class.aspx.cs" Inherits="db" EnableSessionState=true%>
...
<body>
  <form id="adminPage" runat="server"> 
    <asp:Button id="classHome" onclick="goHome" runat="server" Text="Class Home"></asp:Button>
    ...
    <asp:Panel ID="addPanel" runat="server" Wrap="true" Visible="false">
      ...
      <h3>Class Name</h3><asp:TextBox ID="add_classNameTB" MaxLength="20" runat="server"   /> 
      <h3>Class Description</h3><asp:TextBox ID="add_classDescTB" MaxLength="20" runat="server"   /> 
      <h3>Class Cost</h3><asp:TextBox ID="add_classCostTB" MaxLength="20" runat="server"   /> 
   ...
   <asp:Panel ID="addConformation" runat="server" Wrap="true" Visible="false">
    ...
    <asp:Panel ID="updateTable" runat="server" Wrap="true" Visible="false">
      ...
      <asp:ListBox id="update_classNamesLB" AutoPostBack="true" OnSelectedIndexChanged="update_record" runat="server"/></asp:ListBox>
    </asp:Panel>
    ...
    <asp:Panel ID="updatePannel" runat="server" Wrap="true" Visible="false">
      ...
      <h3>Class Name</h3><asp:TextBox id="update_classNameTB" runat="server"/>
      <h3>Class Description</h3><asp:TextBox id="update_classDateTB" runat="server"/>
      <h3>Class Cost</h3><asp:TextBox id="update_classCostTB" runat="server"/>
    ...
    <asp:Panel ID="deleteTable" runat="server" Wrap="true" Visible="false">
      ...
      <asp:ListBox id="delete_classNamesLB" AutoPostBack="true" OnSelectedIndexChanged="delete_record" runat="server"/></asp:ListBox>
    </asp:Panel> 
    ...
    <asp:Panel ID="deletePannel" runat="server" Wrap="true" Visible="false">
      ...
      <h3>Class Name</h3><asp:TextBox id="delete_classNameTB" runat="server"/>
      <h3>Class Description</h3><asp:TextBox id="delete_classDateTB" runat="server"/>
      <h3>Class Cost</h3><asp:TextBox id="delete_classCostTB" runat="server"/>
